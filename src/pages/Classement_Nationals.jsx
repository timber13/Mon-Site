...
export default function ClassementNationals({ tablesNationals = [] }) {
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>Classement Nationals</h2>
      {getClassement(tablesNationals).length === 0 ? (
        ...
        <table style={styles.table}>
          ...
          <tbody style={styles.tbody}>
            {getClassement(tablesNationals).map((team, idx) => {
              const isOdd = idx % 2 === 1;
              return (
                <tr
                  key={team.team}
