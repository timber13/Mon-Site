...
export default function Club() {
  ...
  const handleEditSave = () => {
    const updatedClubs = clubs.map(club =>
      club === selectedClub
        ? { ...club, name: editName, city: editCity, image: editImage, description: editDescription, link: editLink, color1: editColor1, color2: editColor2 }
        : club
    );
    setClubs(updatedClubs);
    localStorage.setItem('clubs', JSON.stringify(updatedClubs));
    setSelectedClub({ ...selectedClub, name: editName, city: editCity, image: editImage, description: editDescription, link: editLink, color1: editColor1, color2: editColor2 });
    setEditModal(false);
  };
    ...
    return (
      <div style={{
        ...
        <div style={{ marginTop: 32, width: '100%' }}>
          <h3 style={{ color: '#c00', fontSize: 24, marginBottom: 12 }}>Résultats du club</h3>
          {clubMatchs.length === 0 ? (
            <div style={{ color: '#888', fontSize: 18 }}>Aucun match trouvé pour ce club.</div>
          ) : (
        ...
        {editModal && (
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{ fontFamily: 'Oswald, Arial Black, Arial, sans-serif', color: '#c00', marginBottom: 18, fontSize: 26 }}>Modifier le club</h2>
              <input
                type="file"
                accept="image/*"
              ...
              <div style={{ display: 'flex', gap: 16, marginBottom: 18 }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <label htmlFor="editColor1" style={{ fontSize: 14, marginBottom: 4 }}>Couleur principale</label>
                  <input
                    id="editColor1"
                    type="color"
                    value={editColor1}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <label htmlFor="editColor2" style={{ fontSize: 14, marginBottom: 4 }}>Couleur secondaire</label>
                  <input
                    id="editColor2"
                    type="color"
                    value={editColor2}
