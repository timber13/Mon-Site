...
export default function ResultatsRegionalWest({ isAdmin, tablesWest, setTablesWest, useSupabase }) {
  ...
  const handleImport = async (e) => {
    ...
    try {
      ...
      if (useSupabase) {
        await supabase.from('resultats_regional_west').upsert(updated);
      }
      setTables([...updated]);
    } catch (err) {
